...
class Ves_Autosearch_Block_System_Config_Form_Field_Information  extends Mage_Adminhtml_Block_Abstract implements Varien_Data_Form_Element_Renderer_Interface
{
	public function render(Varien_Data_Form_Element_Abstract $element)
    {
        $useContainerId = $element->getData('use_container_id');
        return sprintf('<tr class="system-fieldset-sub-head" id="row_%s"><td colspan="5" class="ves-description">
					   <h3>	<a href="http://www.venustheme.com"><b>Magento - Venus Auto Search Block</b></a>  </h3>
								Search products auto complete.<br>
							<br>
							...
							<div>
								...
								<ul>
									<li>&ltblock type="ves_autosearch/autosearch" name="ves_autosearch" /&gt</li>
									<li>{{block type="ves_autosearch/autosearch" name="ves_autosearch"}}</li>
								</ul>
